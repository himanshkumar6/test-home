...
const Navbar = () => {
  return (
    <>
      {/* Desktop Navbar */}
      <div className="flex justify-between lg:mx-36 items-center lg:justify-between">
        <div>
        ...
        <a href="/"><h1 className="font-semibold border-[3px] md:px-6 md:py-2 px-3 py-1 text-lg md:text-base">Get in touch</h1></a>
